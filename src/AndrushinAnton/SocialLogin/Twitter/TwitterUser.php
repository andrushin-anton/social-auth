<?php
namespace AndrushinAnton\SocialLogin\Twitter;

use AndrushinAnton\SocialLogin\Interfaces\SocialUserInterface;
...
class TwitterUser implements SocialUserInterface
{
    ...
    public function getFirstname()
    {
        if(array_key_exists('name', $this->userData)) {
            list($firstname, $lastname) = explode(" ", $this->userData['name']);
            return $firstname;
        }
        return null;
    }
